...
import { FRONTEND_WEBSITE_GROUP } from "@/config/frontend-website";
import {
  HOME_API_PATH,
...
export type { FieldType, FormField } from "@/config/cms-field-types";
...
export const SIDEBAR_GROUPS: SidebarGroup[] = [
  ...
  {
    label: FRONTEND_WEBSITE_GROUP.label,
    items: [
      {
        label: FRONTEND_WEBSITE_GROUP.label,
        icon: FRONTEND_WEBSITE_GROUP.icon,
        children: FRONTEND_WEBSITE_GROUP.pages.map((p) => ({
          href: p.href,
          label: p.label,
        })),
      },
  ...
  {
    label: "CMS",
    items: CMS_MODULES.filter((m) => m.group === "cms").map((m) => ({
      href: `/manage/${m.slug}`,
      label: m.label,
  ...
  },
  {
    label: "Section",
    items: [
      { href: "/manage/fields", label: "Fields", icon: Layers },
      { href: "/manage/why-yaclam", label: "Why Yaclam", icon: Sparkles },
      { href: "/manage/practitioners", label: "Practitioners", icon: UserCircle },
      { href: "/manage/testimonials", label: "Testimonials", icon: MessageSquare },
    ],
  },
  {
    label: "Course",
    items: [
      {
        ...
        icon: BookOpen,
        children: [
          { href: "/manage/courses-page", label: "CMS" },
          { href: "/manage/course", label: "Section" },
        ],
      },
      { href: "/manage/roadmap", label: "Roadmaps", icon: Map },
      { href: "/manage/scholarship", label: "Scholarships", icon: GraduationCap },
      { href: "/manage/blog-post", label: "Blog Posts", icon: Newspaper },
    ],
  },
];