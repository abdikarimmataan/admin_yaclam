...
import type { TestimonialRecord } from "@/app/testimonials/model/testimonial.model";
import { getTestimonialLabel } from "@/app/testimonials/model/testimonial.model";

type TestimonialTableProps = {
  loading: boolean;
  paginated: TestimonialRecord[];
  startIdx: number;
  search: string;
  page: number;
  pageSize: number;
  ...
  onEdit: (item: TestimonialRecord) => void;
  onToggleVisible: (item: TestimonialRecord) => void;
};
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-3 py-2 font-medium text-slate-900">
                      {getTestimonialLabel(item)}
                    </td>
                    <td className="px-3 py-2 text-slate-600">{String(item.role ?? "—")}</td>
                    <td className="px-3 py-2">
                      <label className="inline-flex cursor-pointer items-center gap-2">
                        <input
                          ...
                          aria-label={`Toggle visibility for ${getTestimonialLabel(item)}`}
                        />
