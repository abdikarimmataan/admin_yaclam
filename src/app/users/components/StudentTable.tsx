...
import type { StudentRow } from "@/app/users/model/user.model";
...
type StudentTableProps = {
  ...
  onEdit: (item: StudentRow) => void;
  onToggleStatus: (item: StudentRow) => void;
  onToggleApprove: (item: StudentRow) => void;
  onDelete: (item: StudentRow) => void;
};
        ...
        <table className="w-full min-w-[720px] text-xs">
          <thead>
            <tr className="border-b border-slate-100">
              {["No.", "Name", "Email", "Phone", "Status", "Approved", "Actions"].map((h) => (
                <th
                  key={h}
