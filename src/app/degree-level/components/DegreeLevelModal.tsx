...
import { DegreeLevelForm } from "@/app/degree-level/components/DegreeLevelForm";

type DegreeLevelModalProps = {
  open: boolean;
  title: string;
  submitLabel: string;
...
export function DegreeLevelModal({
  open,
  title,
  submitLabel,
  form,
    ...
    >
      ...
      >
        ...
        <div className="px-6 py-4">
          <DegreeLevelForm fields={fields} form={form} formErrors={formErrors} onChange={onChange} />
        </div>
