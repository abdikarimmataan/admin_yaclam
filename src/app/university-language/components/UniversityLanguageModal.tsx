...
import { UniversityLanguageForm } from "@/app/university-language/components/UniversityLanguageForm";
...
export function UniversityLanguageModal(props: Props) {
    ...
    >
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white shadow-xl" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="px-6 py-4">
          <UniversityLanguageForm fields={fields} form={form} formErrors={formErrors} onChange={onChange} />
        </div>
