...
import {
  ...
  getUniversityLanguageLabel,
  type UniversityLanguageRecord,
} from "@/app/university-language/model/university-language.model";

type UniversityLanguageTableProps = {
  loading: boolean;
  paginated: UniversityLanguageRecord[];
  startIdx: number;
  search: string;
  page: number;
  pageSize: number;
  ...
  onEdit: (item: UniversityLanguageRecord) => void;
  onDelete: (item: UniversityLanguageRecord) => void;
  onToggleVisible: (item: UniversityLanguageRecord) => void;
};

export function UniversityLanguageTable({
  loading,
  paginated,
  startIdx,
  search,
          ...
          <tbody>
            {loading ? (
              ...
              paginated.map((item, i) => {
                ...
                const label = getUniversityLanguageLabel(item);
