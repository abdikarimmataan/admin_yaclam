...
import { InstructorRoleForm } from "@/app/instructor-roles/components/InstructorRoleForm";

type InstructorRoleModalProps = {
  open: boolean;
  title: string;
  submitLabel: string;
...
export function InstructorRoleModal({
  open,
  title,
  submitLabel,
  form,
