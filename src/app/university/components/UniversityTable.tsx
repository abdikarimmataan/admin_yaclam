...
type UniversityTableProps = {
  ...
  onEdit: (item: UniversityRecord) => void;
  onDelete: (item: UniversityRecord) => void;
};
        ...
        <table className="w-full min-w-[720px] text-xs">
          <thead>
            <tr className="border-b border-slate-100">
              {["No.", "Name", "Country", "Location", "Actions"].map((h) => (
                <th
                  key={h}
          ...
          <tbody>
            {loading ? (
              ...
              paginated.map((item, i) => {
                ...
                const label = getUniversityLabel(item);
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-3 py-2 text-slate-600">{countryLabelFromUniversity(item)}</td>
                    <td className="px-3 py-2 text-slate-600">{locationLabelFromUniversity(item)}</td>
